...
\begin{table*}[t]
    ...
    \begin{tabularx}{\textwidth}{lXllll}
        ...
        \middlehline
        $\alpha$\textsuperscript{*} & Fraction of the total storage corresponding to the flood limit & $V_f = \alpha V_{\max}$ & 0.2 & 0.99 & 0.97 \\
        ...
        $\gamma$\textsuperscript{**} & Proportion between flood and normal limits corresponding to the adjusted normal limit & $V_n' = V_n + \gamma (V_f - V_n)$ & 0.001 & 0.999 & 0.633 \\
        $\delta$\textsuperscript{*} & Factor of the 100-year inflow ($I_{100}$) that defines the flood outflow & $Q_f = \delta I_{100}$ & 0.1 & 0.5 & 0.3 \\
        $\epsilon$\textsuperscript{*}$^,$\textsuperscript{**} & Ratio between normal and flood outflows & $Q_n = \epsilon Q_f$ & 0.001 & 0.999 & $Q_f / \bar{I}$ \\
        $k$ & Release coefficient & & 1 & 5 & 1.2 \\
        \bottomhline
    \end{tabularx}
    \belowtable{
        \textsuperscript{*} Parameter identical in LISFLOOD and CaMa-Flood.\\
        \textsuperscript{**} Parameter adjusted in a standard LISFLOOD calibration.
    }
\end{table*}
...
\begin{table*}[t]
    ...
    \begin{tabularx}{\textwidth}{lXlclll}
        ...
        $\delta$\textsuperscript{*} & Factor of the 100-year inflow ($I_{100}$) that defines the flood outflow & $Q_f = \delta I_{100}$ & 0.1 & 0.5 & 0.3 \\
        $\epsilon$\textsuperscript{*} & Ratio between normal and flood outflows & $Q_n = \epsilon Q_f$ & 0.001 & 0.999 & $Q_f / \bar{I}$ \\
         \bottomhline
    \end{tabularx}
    \belowtable{
        \textsuperscript{*} Parameter identical in LISFLOOD and CaMa-Flood.
...
\begin{table*}[t]
    ...
    \begin{tabularx}{\textwidth}{llXl}
        ...
        \middlehline
        \textbf{Storage} & $A, a$\textsuperscript{*} & Average filling & Eq.~\ref{eq:starfit_nor} \\
                         & $B, b$\textsuperscript{*} & Coefficient of the sine component & Eq.~\ref{eq:starfit_nor} \\
                         & $C, c$\textsuperscript{*} & Coefficient of the cosine component & Eq.~\ref{eq:starfit_nor} \\
                         & $\hat{V}_{\min}, \hat{v}_{\min}$\textsuperscript{*} & Lower limit to the filling & Eq.~\ref{eq:starfit_nor} \\
                         & $\hat{V}_{\max}, \hat{v}_{\max}$\textsuperscript{*} & Upper limit to the filling & Eq.~\ref{eq:starfit_nor} \\
        \middlehline
        \textbf{Release} & $Q_{\min}$ & Minimum release & $Q_1$\textsuperscript{**} \\
                         & $Q_{\max}$ & Maximum release & $Q_{99}$\textsuperscript{**} \\
    ...
    \end{tabularx}
    \belowtable{
        \textsuperscript{*} Upper case refers to the upper NOR, and lower case to the lower NOR.\\
        \textsuperscript{*} Percentiles of the observed daily flows.
    }
\end{table*}
...
For a detailed analysis of model performance across each routine and variable, Appendix~\ref{app:kge_components} presents the decomposition of the \KGEmod.
