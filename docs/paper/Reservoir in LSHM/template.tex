...
\title{Comparison of reservoir routines for large scale hydrological models}


% \Author[affil]{given_name}{surname}

\Author[1][jesus.casado-rodriguez@ec.europa.eu]{Jesús}{Casado-Rodríguez} %% correspondence author
...
\subsection{Reservoir characteristics}

% GRanD/GDW

\subsection{Reservoir operations}
...
\subsection{What is the most relevant target variable when calibrating reservoirs?}

% compare the performance when calibrating with different target variables

\subsection{What is the best-performing reservoir routine?}
...
code: https://github.com/casadoj/lisflood-reservoirs
data: ResOpsUS (https://zenodo.org/records/6612040), GRanD/GDW (https://www.globaldamwatch.org/)
